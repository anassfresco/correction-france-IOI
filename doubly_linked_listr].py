...
class linked_list:
    ...
    def insert_with_index(self,data,index):
        ...
        while i<index:
            ...
            actual_node=actual_node.next_node
            i=i+1
        previous_node.next_node,new_data.next_node,new_data.prev_node=new_data,actual_node,previous_node
...
linked.insertstart(4)


# linked.insert_with_index(23,2)
linked.item_by_previous()
linked.seize2()
